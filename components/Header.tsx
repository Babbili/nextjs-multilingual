...
const Header: React.FC<headerPropsType> = ( headerProps: headerPropsType) => {
    ...
    return(
        <header className={styles.header}>
            <h3>{t.title}</h3>
            <ul className={styles.lang__selector} ref={langSelector} onClick={()=> showLangSelector()}>
